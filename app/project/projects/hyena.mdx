---
title: "A Service-Center Tool to Identify, Connect, and Configure E-bikes"
...
cardDescription: "A service-center feature integrated into existing e-bike software, halving servicing time by extending tooling rather than rebuilding."
featured: true
order: 4
publishedAt: "2021"
category: "Work Experience"
coverImage: "/project/hyena/hero.png"
...
glanceTitle: "Designing the end-to-end service flow — identify, connect, configure, update — inside the tool technicians already used."
glanceSummary: "Regional service centers needed a fast, reliable way to check an e-bike's status and re-configure it after sales. Instead of customizing the factory assembly tool, we designed a new feature inside the existing bike service tool that walked technicians from bike identification through Bluetooth connection to configuration and update — collapsing a multi-app workflow into a single screen sequence."
