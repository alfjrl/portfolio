...
export default async function ProjectPage({ params }) {
  ...
  return (
    <div className="w-full">
      <div className="max-w-[1280px] w-full md:mx-auto p-4 md:pb-16 border-x border-gray-200">
        {/* Hero image */}
        <div
        ...
        {category}
            ...
            <h1 className="text-2xl md:text-3xl text-gray-900 font-black tracking-tight mb-2">
              {title}
            </h1>
          ...
          <dl className="flex flex-col md:flex-row gap-4 w-full">
            <div
              className="flex-auto md:basis-1/3 p-4 border border-gray-200 bg-white"
      ...
      {/* Project at a glance */}
      <div className="w-full border-y border-gray-200 bg-[#fafcfd]">
        <div className="max-w-[1280px] w-full md:mx-auto p-4 md:py-16 border-x border-gray-200">
          <h2 className="text-xl md:text-2xl text-gray-900 font-black mb-4 md:mb-8 animate-blur-in">
            Project at a Glance
          </h2>
          <div
            className="max-w-[1280px]  md:mx-auto p-4 border-x bg-white border border-gray-200 animate-blur-in"
