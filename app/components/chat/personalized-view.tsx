  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <section className="flex flex-col gap-3">
        ...
        <div className="chat-markdown text-gray-700 md:text-lg">
          ...
          {data.picks.map((card, index) => (
            ...
            >
              ...
              <div className="md:basis-1/2 flex flex-col justify-center">
                <span className="text-xs font-semibold uppercase tracking-wide text-gray-400 mb-1">
                  Why this is for you
                </span>
                <div className="chat-markdown text-sm md:text-base text-gray-700">
